...
REM change D to DN
REM changw Q to QN
REM dim Z(7) for max players

2 PRINT TAB(31);"BLACK JACK"
4 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
6 PRINT:PRINT:PRINT

'#define FNA(QN) (QN+11*(QN>=22))
10 REM DEF FNA(Q)=Q+11*(Q>=22)
...
110 IF CN<51 THEN 230
120 PRINT "RESHUFFLING"
130 FOR DN=DN TO 1 STEP -1
140 CN=CN-1
150 C(CN)=D(DN)
160 NEXT DN
170 FOR C1=52 TO CN STEP -1
180 C2=INT(RND(1)*(C1-CN+1))+CN
190 C3=C(C2)
200 C(C2)=C(C1)
210 C(C1)=C3
220 NEXT C1
...
520 Q1=QN+X1
530 IF QN>=11 THEN 590
540 IF X>1 THEN 570
550 QN=QN+11
560 RETURN
570 QN=Q1-11*(Q1>=11)
580 RETURN
590 QN=Q1-(QN<=21 AND Q1>21)
600 IF QN<33 THEN 620
610 QN=-1
620 RETURN
...
1800 D1=N+1
1810 IF 2*D1+CN>=52 THEN GOSUB 120
1820 IF CN=2 THEN CN=CN-1
