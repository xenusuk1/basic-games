...
260 REM ***
270 DIM A(20, 20), D(9)
275 PRINT "DO YOU WANT INSTRUCTIONS";
276 INPUT A$
277 IF LEFT$(A$, 1) = "Y" THEN GOSUB 7000
...
1190 PRINT "WILL WARN ALL SUBS TO STAY FROM RADIOACTIVE AREA!!!"
1200 GOTO 6180
1210 X = S1
1220 Y = S2
1230 Q1 = 1
...
2340 PRINT "PRESSURE IMPLODES SUB UPON FIRING...YOU'RE CRUSHED!!"
2350 GOTO 6180
2360 GOSUB 6080
2370 X = S1
2380 Y = S2
...
3540 PRINT
3550 PRINT "WANT DAMAGE REPORT";
3560 INPUT A$
3570 IF LEFT$(A$, 1) = "N" THEN 3670
3580 PRINT "   ITEM         DAMAGE  (+ GOOD, 0 NUETRAL, - BAD)"
3590 PRINT "   ----         ------"
...
4340 PRINT D7; "MEN WERE REATEN "; N$; "!!"
4350 C = C - D7
...
6200 PRINT "YOU WILL BE DEMOTED TO RANK OF DECK SCRUBBER!!!"
...
6320 END
7000 PRINT "THIS IS THE GAME OF SEA BATTLE!!! THE OBJECT OF THE GAME IS TO"
7010 PRINT "DESTROY ALL OF THE ENEMY SHIPS IN YOUR 20 BY 20 AREA WITH THE"
7020 PRINT "VARIOUS WEAPONS IN YOUR SUBMARINE'S ARSENAL. YOU MUST DO THIS,"
7030 PRINT "HOWEVER, WITHOUT LETTING THE ENEMY DESTROY YOU FIRST!!"
7040 PRINT
7050 PRINT "THERE ARE SEVERAL INTERESTING HAZARDS IN THE GAME. THEY INCLUDE:"
7060 PRINT "  .. DEPTH CHARGES FROM NEARBY ENEMY SHIPS."
7070 PRINT "  .. VERY HUNGRY SEA MONSTERS!!"
7080 PRINT "  .. AND HIDDEN UNDERWATER MINES."
7090 PRINT ""
7100 PRINT "THE DEPTH CHANGES ARE EFFECTIVE TO ANY DEPTH, BUT THEY LOSE"
7110 PRINT "THEIR EFFECTIVNESS OVER DISTANCE, SO THE FARTHER YOU ARE FROM"
7120 PRINT "ANY SHIPS, THE BETTER!"
7130 PRINT "THE SEA MONSTERS TAKE A MEANDERING COURSE THROUGH YOUR AREA THAT"
7140 PRINT "MAY BRING IT CLOSE ENOUGH TO ATTACK YOU. YOU RARELY SURVIVE."
7150 PRINT "THEY ALSO LIKE TO EAT YOUR TORPEDOS, BUT MISSILES WILL KILL THEM."
7160 PRINT
7170 PRINT "THE ENEMY SHIPS MOVE ON EVERY TURN, IN A FIXED COURSE, UNLESS THEY"
7180 PRINT "ENCOUNTER OBSTACLES. THEY WILL GET BLOWN UP BY MINES, AND GET"
7190 PRINT "EATEN BY SEA MONSTERS TOO."
7200 INPUT Z$: PRINT
7210 PRINT "YOU HAVE TEN ORDERS THAT YOU MAY GIVE. THEY ARE:"
7220 PRINT
7230 PRINT "    #0: NAVIGATION - THIS COMMAND ALLOWS YOU TO MOVE IN A"
7240 PRINT "PARTICULAR DIRECTION AND DISTANCE ACROSS YOUR AREA. THE"
7250 PRINT " 8 1 2  DIRECTION IS DETERMINED BY THE GRAPH AT LEFT. THERE"
7260 PRINT "  \'/   ARE 8 DIRECTIONS TO MOVE IN, AND THEY ARE THE SAME"
7270 PRINT " 7-*-3  ANYTIME YOU ARE ASKED FOR A COURSE. FOR EXAMPLE,"
7280 PRINT "  /'\   TO MOVE NORTH, YOU WOULD USE COURSE #1. THE COMPUTER"
7290 PRINT " 6 5 4  WILL ALSO ASK FOR AN AMOUNT OF POWER. IT TAKES 100 UNITS"
7300 PRINT "OF POWER TO MOVE YOUR SUB 1 SPACE. BEWARE OF OBSTACLES!!"
7310 PRINT "IF YOU USE MORE THAN 1000 UNITS IN A TURN, THERE IS AN OVERLOAD"
7320 PRINT "DANGER, SO BE VERY CAREFUL!!"
7330 PRINT
7340 PRINT "    #1: SONAR - THIS COMMAND HAS TWO OPTIONS. OPTION #1 GIVES"
7350 PRINT "DIRECTIONAL INFORMATION, SHOWING THE DIRECTIONS AND DISTANCES"
7360 PRINT "IN WHICH THERE ARE ENEMY SHIPS. THIS IS USEFUL FOR SHOOTING AT LONG"
7370 PRINT "RANGES, WHERE IT IS DIFFICULT TO TELL IF A SHIP IS IN DIRECT LINE."
7380 INPUT Z$: PRINT
7390 PRINT "  OPTION #0 PRINTS OUT A MAP OF YOUR AREA IN A SQUARE."
7400 PRINT "(IT USES SYMBOLS FOR THE MAP) '*' INDICATES DRY LAND, '$' IS"
7410 PRINT "AN UNDERWATER MINE, '\S/' IS AN ENEMY SHIP. '-#-' IS A SEA MONSTER."
7420 PRINT "'!H!' IS YOUR HEADQUARTERS, AND FINALLY, '(X)' IS YOU!!!"
7430 PRINT
7440 PRINT "EVERY SO OFTEN, A '.' WILL APPEAR INSIDE THE SCREEN. THIS IS"
7450 PRINT "A SONAR MALFUNCTION, AND SO THE OBJECT THERE ISN'T IDENTIFIED."
7460 PRINT "IF YOU ARE ABOVE 50 FEET, WAVES WILL SHOW UP AS '.'."
7470 PRINT
7480 PRINT "    #2: TORPEDO CONTROL - THIS COMMAND ALLOWS YOU TO SHOOT"
7490 PRINT "1 OF YOUR 10 TORPEDOS AT ENEMY SHIPS. THE COMPUTER WILL ONLY"
7500 PRINT "REQUIRE THE DIRECTION TO SHOOT, USING THE INDICATOR ABOVE."
7510 PRINT "THEY HAVE A RANGE OF 7-13 SPACES. ONE TORPEDO GETS ONE SHIP."
7520 PRINT
7530 PRINT "    #3: POLARIS MISSILE CONTROL - THIS COMMAND ALLOWS YOU TO"
7540 PRINT "LAUNCH ONE OF YOUR POLARIS MISSILES AGAINST THE ENEMY. THE"
7550 PRINT "COMPUTER WILL ASK FOR A COURSE AND FUEL. IT TAKES 75 LBS. OF FUEL"
7560 PRINT "TO BOOST A MISSILE 1 SPACE. SINCE THEY ARE SO MUCH MORE POWERFUL,"
7570 PRINT "THEY WILL COMPLETELY DESTROY THE SPACE THEY LAND ON, PLUS ALL"
7580 PRINT "OF THE IMMEDIATELY ADJACENT ONES. MISSILES DESTROY EVERYTHING!!!"
7590 INPUT Z$: PRINT
7600 PRINT "    #4: MANUEVERING - THIS COMMAND ALLOWS YOU TO CHANGE THE"
7610 PRINT "DEPTH YOU'RE AT. YOU MAY WANT TO DO THIS IF YOU ARE BADLY"
7620 PRINT "DAMAGED, BECAUSE REPAIRS GO ON TWICE AS QUICKLY BELOW"
7630 PRINT "2500 FT. AND ABOVE 50 FT. THAN IN BETWEEN. YOU START THE GAME AT 100 FT."
7640 PRINT "YOU USE UP ABOUT 1 POWER UNIT FOR EVERY 2 FT. YOU CHANGE."
7650 PRINT
7660 PRINT "    #5: STATUS/DAMAGE REPORT - THIS COMMAND GIVES YOU THE"
7670 PRINT "STATUS OF YOUR SUB. IT TELLS YOU HOW MUCH IS LEFT IN YOUR"
7680 PRINT "ARSENAL, WHICH ITEMS ARE DAMAGED, AND HOW MUCH."
7690 PRINT
7700 PRINT "    #6: HEADQUARTERS - THIS COMMAND ALLOWS SCUBA DIVERS FROM"
7710 PRINT "YOUR HEADQUARTERS TO REPLENISH YOUR SUPPLY OF WEAPONS AND MEN."
7720 PRINT "YOU MUST BE AT 50 FT. OR LESS, AND 2 OR LESS SPACES AWAY TO DO"
7730 PRINT "THIS HOWEVER, AND YOU CAN ONLY DO IT TWICE."
7740 PRINT
7750 PRINT "    #7: SABOTAGE (SCUBA) - THIS COMMAND ALLOWS YOU TO SEND"
7760 PRINT "MEN OUT ON A SABOTAGE MISSION AGAINST ENEMY SHIPS. YOU MAY"
7770 PRINT "ONLY GO AGAINST SHIPS WITHIN 3 SPACES OF YOU, AND YOU MUST"
7780 PRINT "LEAVE AT LEAST 10 MEN ON BOARD THE SUB TO RUN IT."
7790 INPUT Z$: PRINT
7800 PRINT "    #8: POWER CONVERSION - THIS COMMAND ALLOWS YOU TO CHANGE FUEL"
7810 PRINT "TO POWER, OR VICE-VERSA."
7820 PRINT
7830 PRINT "    #9: SURRENDER - THIS COMMAND IS ONLY FOR COWARDS AND TRAITORS!!"
7840 PRINT
7850 PRINT
7860 PRINT "YOU START THE GAME WITH THE FOLLOWING SUPPLIES:"
7870 PRINT "   6000 UNITS OF POWER, 2500 LBS. OF ROCKET FUEL, 10 TORPEDOS"
7880 PRINT "   3 MISSILES, 1 HEADQUARTERS, AND A RANDOM NUMBER OF SHIPS."
7890 PRINT
7900 PRINT "  I LEFT SOME INTERESTING DETAILS OUT OF THE INSTRUCTIONS,"
7910 PRINT "TO MAKE PLAYING THE GAME THE FIRST FEW TIMES MORE INTERESTING."
7920 PRINT
7930 PRINT "YOU START THE GAME IN THE ISLAND'S LAGOON, AND IT IS YOUR DUTY"
7940 PRINT "TO SEEK OUT AND DESTROY THE ENEMY AT ALL COSTS!!!"
7950 INPUT Z$: PRINT
7960 RETURN
